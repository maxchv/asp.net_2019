...
namespace lesson17.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(DbContextDemo context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Value")] Data data)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Value")] Data data)
        {
            if (id != data.Id)
            {
                return NotFound();
